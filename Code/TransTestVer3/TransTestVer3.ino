...
//   const unsigned char Diode[] MEM_TEXT = "Diode: ";
  ...
  const unsigned char TestRunning[] MEM_TEXT = "Checking...";
...
const unsigned char VERSION_str[] MEM2_TEXT = " KMA ELECTRICAL";
...
byte TestKey;
byte BUTTON_TEST = 17;  // A3

#define BUTTON_MENU 5  //Nút nhấn 
#define BUTTON_OK 6  //Nút nhấn 
// byte BUTTON_TEST= 2 ; //Nút nhấn 
#define BUZZER 4 //Khởi tạo còi chip
int MODE=1;
// BẮT ĐẦU CHƯƠNG TRÌNH
void setup()
{
  Serial.begin(9600);
  Serial.println("Khởi tạo chương trình chính!");
  ...
  lcd.init();
  lcd.backlight();
  lcd_set_cursor(0,0);lcd_string(" KMA ELECTRICAL");
...
// {
//   // if(MODE==1){
//   //   Serial.println("Chương trình kiểm tra linh kiện!");
//   //   while(MODE==1){      
//   //     COMPONENT_TEST_PROGRAM();       
//   //   }   
//   // }
//   // if(MODE==2){
//   //   Serial.println("Chương trình kiểm tra cuộn cảm!");
//   //   while(MODE==2){
//   //     INDUCTOR_TEST_PROGRAM();       
//   //   }   
//   // }
//     COMPONENT_TEST_PROGRAM();
// }
void INDUCTOR_TEST_PROGRAM()
{
}
void loop()
{
...
start:
  ...
  TestKey = 1;
  while(TestKey) {
    TestKey = digitalRead(BUTTON_TEST);
    delay(100);
  }
  while(!TestKey) {
    TestKey = digitalRead(BUTTON_TEST);
